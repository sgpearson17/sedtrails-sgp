...
@pytest.mark.parametrize("g, rhoS, rhoW, visc_kin, d, expected", [
...
def test_dstar(g, rhoS, rhoW, visc_kin, d, expected):
    ...
    assert np.isclose(dstar_value, expected, rtol=1e-3), f"Failed for g={g}, rhoS={rhoS}, rhoW={rhoW}, visc_kin={visc_kin}, d={d}"
