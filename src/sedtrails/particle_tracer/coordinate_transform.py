...
class CoordinateTransform:
    ...
    def __post_init__(self) -> None:
        ...
        if self.metric_crs is None:
            raise ValueError('metric_crs is required for geographic coordinate transforms.')
    ...
    def metadata(self) -> dict[str, float | int | str]:
        ...
        metadata: dict[str, float | int | str] = {
            ...
            'metric_coordinate_system': _metric_coordinate_system_label(self._metric_crs_obj),
        }
...
def build_coordinate_transform(
    ...
    *,
    ...
    return CoordinateTransform('geographic', source_crs or DEFAULT_SOURCE_CRS, resolved_metric_crs)
...
def coordinate_transform_from_metadata(metadata) -> CoordinateTransform:
    ...
    return CoordinateTransform('geographic', source_crs, metric_crs)
